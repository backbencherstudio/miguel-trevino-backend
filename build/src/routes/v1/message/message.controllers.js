...
exports.sendMessage = exports.getChatformRoom = exports.getUserChatRoom = exports.getAllChatRooms = void 0;
...
//   }
// };
const getAllChatRooms = async (request, reply) => {
    try {
        const prisma = request.server.prisma;
        const page = parseInt(request.query.page) || 1;
        const limit = parseInt(request.query.limit) || 10;
        ...
        const rooms = chatRooms.map((room) => ({
            ...
            user: {
                ...
                avatar: room.user.avatar
                    ? (0, baseurl_1.getImageUrl)(`/uploads/${room.user.avatar}`)
                    : null,
            },
...
const getUserChatRoom = async (request, reply) => {
    try {
        const prisma = request.server.prisma;
        ...
        const room = {
            ...
            user: {
                ...
                avatar: chatRoom.user.avatar
                    ? (0, baseurl_1.getImageUrl)(`/uploads/${chatRoom.user.avatar}`)
                    : null,
            },
...
exports.getUserChatRoom = getUserChatRoom;
const getChatformRoom = async (request, reply) => {
    try {
        const prisma = request.server.prisma;
            ...
            messages: chatRoom.messages.map((msg) => ({
                ...
                sender: {
                    ...
                    avatar: msg.sender.avatar
                        ? (0, baseurl_1.getImageUrl)(`/uploads/${msg.sender.avatar}`)
                        : null,
                },
            })),
        };
...
exports.getChatformRoom = getChatformRoom;
